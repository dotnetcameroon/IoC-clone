...
public interface IServiceContainer
{
    ...
    void AddScoped<TService>(TService instance, Func<IServiceResolver, TService> generate) where TService : class;
    void AddScoped<TService>(Func<IServiceResolver, TService> generate) where TService : class;
    void AddScoped<TService, TImplementation>(Func<IServiceResolver, TService> generate) where TImplementation : TService where TService : class;
